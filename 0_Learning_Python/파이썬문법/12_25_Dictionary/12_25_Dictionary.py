...
#############################
# 12.1.2  딕셔너리 키의 자료형
# 키 => 리스트와 딕셔너리를 사용할 수 없습니다    😁
# 딕셔너리의 키는 문자열뿐만 아니라 정수, 실수, 불도 사용할 수 있으며 자료형을 섞어서 사용해도 됩니다.
# 값에는 리스트, 딕셔너리 등을 포함하여 모든 자료형을 사용할 수 있습니다.
################################################################################
x = {100: 'hundred', False: 0, 3.5: [3.5, 3.5]} # {100: 'hundred', False: 0, 3.5: [3.5, 3.5]}
...
# 반환값 : setdefault(키, 기본값)처럼 키와 기본값을 지정하면 값에 기본값을 저장한 뒤 해당 값을 반환합니다.
print(x.setdefault('f', 100))   # 100
